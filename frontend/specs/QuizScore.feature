...
Scenario: Quiz score all question are correct
  ...
  * I click the next button
  ...
  Then I see question 524 "What is the standard colour of sky?" with answer "Blue" and feedback is "Correct"
  Then I see question 19 "What is capital of France?" with answer "Paris" and feedback is "Correct"
  Then I see question 673 "What are cities in France?" with answer "Lyon,Paris,Toulouse" and feedback is "Correct"
...
Scenario: Quiz score one question is inccorect
  ...
  * I click the evaluate button
  ...
  Then I see question 524 "What is the standard colour of sky?" with answer "Green" and feedback is "Incorrect"
  Then I see question 19 "What is capital of France?" with answer "Paris" and feedback is "Correct"
  Then I see question 673 "What are cities in France?" with answer "London,Paris,Toulouse" and feedback is "Incorrect"
